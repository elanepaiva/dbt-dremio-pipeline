...
# Portal de Auditoria Fiscal Digital
...
## Arquitetura Modern Data Lakehouse
...
| :--- | :--- | :--- |
| **Fonte Transacional (OLTP)** | **MySQL** | Armazena os XMLs das NF-e emitidas (Capa e Itens). |
| **Data Lake (Armazenamento)** | **GCP (Parquet)** | Armazena os arquivos SPED processados em formato colunar. |
...
![Fluxo de Auditoria](../assets/fluxo_auditoria.png)
